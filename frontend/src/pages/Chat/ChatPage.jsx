...
const ChatPage = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#F9FAFB] text-slate-900 font-sans">
      {/* Main Container Between Navbar & Footer */}
      <div className="flex-1 py-4 px-2 sm:px-4 md:px-6">
        <div className="max-w-7xl mx-auto flex h-[calc(100vh-140px)] min-h-[640px] bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
          
          {/* ============================================================ */}
          {/* 1. LEFT SIDEBAR (280px, Responsive, Active Chats in Red)     */}
          {/* ============================================================ */}
          <aside className="w-72 bg-white border-r border-slate-200 hidden md:flex flex-col justify-between p-5 flex-shrink-0">
            <div>
              {/* Brand Logo / Chats Header */}
              ...
              <nav className="space-y-1.5 font-medium text-sm text-slate-600">
                <Link
                  to="/messages"
                  className="flex items-center gap-3 px-3.5 py-2.5 rounded-xl bg-red-50 text-red-600 font-bold transition shadow-2xs"
                >
          ...
          {/* ============================================================ */}
          {/* 2. RIGHT MAIN CHAT AREA (Flicker-Free, Real DB Only)         */}
          {/* ============================================================ */}
          <main className="flex-1 flex flex-col bg-[#FCFCFD] overflow-hidden">
            ...
            <header className="bg-white border-b border-slate-200 px-4 md:px-6 py-3 shadow-2xs flex flex-wrap items-center justify-between gap-3 z-10">
              ...
              {/* Right: Verified Badges + 3 Dots Menu */}
            ...
            <div className="flex-1 overflow-y-auto p-4 md:p-6 space-y-4 bg-[#FCFCFD]">
              ...
              {/* MESSAGES LIST OR LOADING SKELETON */}
              {loadingMessages ? (
            ...
            {/* ── C. INPUT COMPOSER (White, border-t, text + emoji + send) */}
            ...
            {/* ── D. BOTTOM UNLOCK BANNER (Yellow #FFFBEB, Hidden if subscribed) */}
            {!isSubscribed && (
            ...
            {/* ── E. BOTTOM SAFETY TRUST ROW (3 COLUMNS) ───────────────── */}
